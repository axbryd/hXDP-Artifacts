...
function master(args)
    ...
    --mg.startTask("replay", dev2:getTxQueue(0), args.file3, args.loop, rateLimiter, args.rateMultiplier)
    --mg.startTask("replay", dev3:getTxQueue(0), args.file4, args.loop, rateLimiter, args.rateMultiplier)
